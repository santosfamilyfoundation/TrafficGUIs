...
class Ui_TransportationSafety(object):
    def setupUi(self, TransportationSafety):
        ...
        self.open_buttons.setMargin(11)
        ...
        self.zoom_sliders.setMargin(11)
        ...
        self.homography_layout.setMargin(11)
        ...
        self.feature_tracking_parameter_widget.setGeometry(QtCore.QRect(0, 0, 613, 578))
        ...
        self.feature_tracking_parameter_layout.setMargin(11)
        ...
        self.feature_tracking_video_layout.setMargin(11)
        ...
        self.gridLayout_14.setMargin(11)
        ...
        self.roadusers_tracking_video_layout.setMargin(11)
        ...
        self.roadusers_tracking_parameter_widget.setGeometry(QtCore.QRect(0, 0, 613, 578))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout_9.setMargin(11)
        ...
        self.results_grid.setMargin(11)
        self.results_grid.setSpacing(6)
        self.results_grid.setObjectName(_fromUtf8("results_grid"))
        self.results_parameter_area = QtGui.QScrollArea(self.tab_results)
        ...
        self.results_parameter_widget.setGeometry(QtCore.QRect(0, 0, 1234, 681))
        ...
        self.results_parameter_form = QtGui.QFormLayout(self.formLayoutWidget)
        self.results_parameter_form.setMargin(11)
        self.results_parameter_form.setSpacing(6)
        self.results_parameter_form.setObjectName(_fromUtf8("results_parameter_form"))
        self.speedLimitLabel = QtGui.QLabel(self.formLayoutWidget)
        self.speedLimitLabel.setObjectName(_fromUtf8("speedLimitLabel"))
        self.results_parameter_form.setWidget(0, QtGui.QFormLayout.LabelRole, self.speedLimitLabel)
        self.speedLimitLineEdit = QtGui.QLineEdit(self.formLayoutWidget)
        self.speedLimitLineEdit.setObjectName(_fromUtf8("speedLimitLineEdit"))
        self.results_parameter_form.setWidget(0, QtGui.QFormLayout.FieldRole, self.speedLimitLineEdit)
        self.timeToCollisionLabel = QtGui.QLabel(self.formLayoutWidget)
        self.timeToCollisionLabel.setObjectName(_fromUtf8("timeToCollisionLabel"))
        self.results_parameter_form.setWidget(2, QtGui.QFormLayout.LabelRole, self.timeToCollisionLabel)
        self.timeToCollisionLineEdit = QtGui.QLineEdit(self.formLayoutWidget)
        self.timeToCollisionLineEdit.setObjectName(_fromUtf8("timeToCollisionLineEdit"))
        self.results_parameter_form.setWidget(2, QtGui.QFormLayout.FieldRole, self.timeToCollisionLineEdit)
        self.vehiclesOnlyLabel = QtGui.QLabel(self.formLayoutWidget)
        self.vehiclesOnlyLabel.setObjectName(_fromUtf8("vehiclesOnlyLabel"))
        self.results_parameter_form.setWidget(3, QtGui.QFormLayout.LabelRole, self.vehiclesOnlyLabel)
        self.vehiclesOnlyCheckBox = QtGui.QCheckBox(self.formLayoutWidget)
        self.vehiclesOnlyCheckBox.setObjectName(_fromUtf8("vehiclesOnlyCheckBox"))
        self.results_parameter_form.setWidget(3, QtGui.QFormLayout.FieldRole, self.vehiclesOnlyCheckBox)
        self.results_parameter_layout = QtGui.QHBoxLayout()
        self.results_parameter_layout.setMargin(11)
    ...
    def retranslateUi(self, TransportationSafety):
        ...
        self.actionFeedback.setText(_translate("TransportationSafety", "Send Feedback", None))
